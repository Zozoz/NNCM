...
def hn(inputs, sen_len, keep_prob1, keep_prob2, id_='1'):
...
def main(_):
    ...
    with tf.device('/gpu:0'):
        ...
        prob_o = hn(inputs_o, len_o, keep_prob1, keep_prob2, 'o')
    with tf.device('/gpu:1'):
        ...
        prob_r = hn(inputs_r, len_r, keep_prob1, keep_prob2, 'r')
    ...
    with tf.Session(config=conf) as sess:
        ...
        # v_x, v_y, v_sen_len = load_inputs_document_nohn(
