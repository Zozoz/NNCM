...
def cnn_lstm(inputs, sen_len, doc_len, keep_prob1, keep_prob2):
    ...
    conv1 = tf.tanh(reduce_mean_with_len(conv1, sen_len - 2))
    ...
    conv2 = tf.tanh(reduce_mean_with_len(conv2, sen_len - 1))
    ...
    conv3 = tf.tanh(reduce_mean_with_len(conv3, sen_len - 0))
